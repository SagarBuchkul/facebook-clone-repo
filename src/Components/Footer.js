...
function Footer() {
    return (
        <>
         <footer className="bg-slate-500 text-center text-white max-sm:w-auto">
            <div className="container px-6 pt-6">
                ...
                <form action="">
                    ...
                    <div className="relative md:mb-6" data-te-input-wrapper-init>
                        <input
                        type="text"
                        className="peer block min-h-[auto] w-full rounded bg-transparent py-[0.32rem] px-3 leading-[1.6] text-gray-700 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 bg-white bg-clip-padding border-solid [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
